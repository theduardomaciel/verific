...
export function Hero() {
	return (
		<section className="px-landing relative mt-8 flex w-full justify-center overflow-hidden">
			<div className="bg-primary container w-full overflow-hidden rounded-2xl p-8 md:p-10 lg:p-12">
